...
public abstract class EntityCustomAITarget extends EntityAIBase
{
    ...
    public EntityCustomAITarget(EntityLiving creature, boolean checkSight)
    {
        this(creature, checkSight, false);
    }

    public EntityCustomAITarget(EntityLiving creature, boolean checkSight, boolean onlyNearby)
    {
    ...
    public EntityCustomAITarget setUnseenMemoryTicks(int p_190882_1_)
    {
