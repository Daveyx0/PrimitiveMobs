...
{
	protected static final DataParameter<Byte> TAMED = EntityDataManager.<Byte>createKey(EntityTameableSlime.class, DataSerializers.BYTE);
    ...
    protected EntityAISlimeSit aiSit;
     ...
     */
    public EntityAISlimeSit getAISit()
    {
        return this.aiSit;
    }
