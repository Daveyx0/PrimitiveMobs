...
public class PrimitiveMobsConfigMobs {
	...
	public static boolean enableChameleon, enableTreasureSlime, enableHauntedTool,
		...
		enableBlazingJuggernaut, enableLilyLurker, enableSpiderFamily;
	...
	public static void load(Configuration config) {
		...
		enableEnchantedBook = config.get(category, "Enable Bewitched Tome", true).getBoolean();
		...
		enableSpiderFamily = config.get(category, "Enable Spider Family", true).getBoolean();
	}
