...
public class LayerPrimitiveSpiderEyes<T extends EntityPrimitiveSpider> implements LayerRenderer<T>
{
    private static final ResourceLocation SPIDER_EYES = new ResourceLocation("textures/entity/spider_eyes.png");
    private final RenderLiving spiderRenderer;

    public LayerPrimitiveSpiderEyes(RenderLiving spiderRendererIn)
    {
