...
public class LayerPrimitiveCreeperCharge implements LayerRenderer<EntityPrimitiveCreeper>
{
    ...
    public void doRenderLayer(EntityPrimitiveCreeper entitylivingbaseIn, float limbSwing, float limbSwingAmount, float partialTicks, float ageInTicks, float netHeadYaw, float headPitch, float scale)
    {
